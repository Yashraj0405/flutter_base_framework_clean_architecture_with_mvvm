...
class ForgotPasswordScreenT1 extends StatefulWidget {
  const ForgotPasswordScreenT1({super.key});

  @override
  State<ForgotPasswordScreenT1> createState() => _ForgotPasswordScreenT1State();
}

class _ForgotPasswordScreenT1State extends State<ForgotPasswordScreenT1> {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Style.getMediumText("passwordRequirements".tr,
                          FontSize.textSize18, Colormanager.red,
                          maxLines: 6,
